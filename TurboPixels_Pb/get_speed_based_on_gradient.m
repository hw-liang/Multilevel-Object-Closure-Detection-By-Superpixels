function [speed,speed_x,speed_y,doublet,curvature] = get_speed_based_on_gradient(Pb, doDoublet, normSigma, phi, speed, speed_x, speed_y)
...
%         [gx,gy] = height_function_der(255*Pb);
%         mag = sqrt(gx.^2 + gy.^2);
