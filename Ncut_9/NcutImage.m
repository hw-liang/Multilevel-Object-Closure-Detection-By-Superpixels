function [SegLabel,NcutDiscrete,NcutEigenvectors,NcutEigenvalues,W,imageEdges]= NcutImage(I,nbSegments, image_data_file);
...
if (nargin >= 3)
    [W,imageEdges] = ICgraph(I, [], [], image_data_file);
else
