function [pb,theta,tmap, pb_unthresh] = pbCGTG(im,radius,norient)
...
if (nargin<2 || isempty(radius)), radius=[0.01 0.02 0.02 0.02]; end
...
% get gradients
[cg,tg,gtheta,tmap] = detCGTG(im,radius,norient);
